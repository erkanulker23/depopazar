...
export class InitialFix1769965820508 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`bank_accounts\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`bank_accounts\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`companies\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`companies\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`customers\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`customers\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`UPDATE \`payments\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`contract_monthly_prices\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`contract_monthly_prices\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`contract_staff\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`contract_staff\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`contracts\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`contracts\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`items\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`items\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`rooms\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`rooms\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`warehouses\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`warehouses\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`transportation_job_staff\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`transportation_job_staff\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`transportation_jobs\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`transportation_jobs\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`notifications\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`notifications\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`company_paytr_settings\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`company_paytr_settings\` SET \`id\` = UUID()`);
        ...
        await queryRunner.query(`ALTER TABLE \`company_mail_settings\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`UPDATE \`company_mail_settings\` SET \`id\` = UUID()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`id\` char(36) COLLATE "utf8mb4_unicode_ci" NOT NULL`);
        await queryRunner.query(`UPDATE \`users\` SET \`id\` = UUID()`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD PRIMARY KEY (\`id\`)`);
