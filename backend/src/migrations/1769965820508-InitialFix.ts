...
export class InitialFix1769965820508 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        for (const fk of foreignKeys) {
            try {
                ...
                // Zaten silinmiş olabilir veya hata verirse atla
            }
        }

        // 3. Yardımcı Fonksiyonlar (Varlık kontrolü ile)
        ...
        // Önce SMS settings tablosunu garantiye alalım
        ...
        // 5. Özel kolon düzenlemeleri (Enum ve Foreign Key Kolonları)
        ...
        // 6. Foreign Key'leri ve İndeksleri Yeniden Oluştur
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`SET FOREIGN_KEY_CHECKS = 0`);
        // Geri dönüş mantığı buraya eklenebilir ancak genelde yıkıcı migrasyonlarda boş bırakılır.
        await queryRunner.query(`SET FOREIGN_KEY_CHECKS = 1`);
    }
}
