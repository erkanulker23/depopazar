...
export class PaytrService {
  ...
  async getPaymentToken(
    ...
    const requestData: PaytrPaymentRequest = {
      ...
      merchant_ok_url: paymentData.okUrl || `${this.configService.get('FRONTEND_URL')}/payments/success`,
      merchant_fail_url: paymentData.failUrl || `${this.configService.get('FRONTEND_URL')}/payments/fail`,
