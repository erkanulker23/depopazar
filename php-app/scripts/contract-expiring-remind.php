 ...
 * Kullanım: php php-app/scripts/contract-expiring-remind.php
 * Cron: 0 9 * * * cd /path/to/site && php php-app/scripts/contract-expiring-remind.php
 */
...
$result = ContractExpiringReminderService::sendAll($pdo, 30);
