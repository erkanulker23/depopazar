...
CREATE TABLE IF NOT EXISTS `contracts` (
  ...
  `exit_document_at` DATETIME DEFAULT NULL COMMENT 'Çıkış belgesi oluşturulma zamanı',
  ...
  `customer_signature_url` VARCHAR(512) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `company_mail_settings` (
  ...
  `notify_customer_on_welcome` TINYINT(1) DEFAULT 1,
  `notify_customer_on_contract_expiring` TINYINT(1) DEFAULT 1,
...
-- personnel (saha personeli — sisteme giriş yapmaz)
