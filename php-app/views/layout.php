...
$navIcons = ['Genel Bakış'=>'house','Yeni Depo Sözleşmesi Ekle'=>'plus-circle','Ödeme Al'=>'bank','Tüm Sözleşmeler'=>'file-text','Nakliye İşler'=>'truck','Araçlar'=>'car-front','Hizmetler'=>'tag','Teklifler'=>'file-earmark-plus','Personel'=>'person-badge','Kullanıcılar'=>'people','Kullanıcı Yetkileri'=>'shield-check','Depolar'=>'building','Odalar'=>'grid-3x3','Müşteriler'=>'people','Depodan Ayrılanlar'=>'box-arrow-right','Ödemeler'=>'credit-card','Masraflar'=>'wallet2','Raporlar'=>'bar-chart','Bildirimler'=>'bell','Ayarlar'=>'gear'];
$navItems = [
    ...
    ['name' => 'Depodan Ayrılanlar', 'href' => '/musteriler/depodan-ayrilanlar', 'active' => $currentPath === '/musteriler/depodan-ayrilanlar'],
