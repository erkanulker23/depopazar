<?php
$currentPage = 'odalar';
$pageTitle = 'Odalar Excel İçe Aktar';
ob_start();
?>
<div class="mb-6">
    <div class="flex flex-wrap items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-2">
        <a href="/odalar" class="text-emerald-600 dark:text-emerald-400 hover:underline font-medium">Odalar</a>
        <i class="bi bi-chevron-right"></i>
        <span class="text-gray-700 dark:text-gray-300 font-medium">Excel İçe Aktar</span>
    </div>
    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-1">Excel ile Oda İçe Aktar</h1>
    <p class="text-sm text-gray-500 dark:text-gray-400">CSV dosyası yükleyerek toplu oda ekleyebilirsiniz. Depo adı yoksa otomatik oluşturulur.</p>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 max-w-2xl">
    <form method="post" action="/odalar/excel-ice-aktar" enctype="multipart/form-data" class="space-y-4">
        <div>
            ...
            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Sütunlar: Depo Adı; Oda No; Alan (m²); Aylık Fiyat; Durum (Boş/Dolu/Rezerve/Kilitli); Kat; Blok; Koridor; Açıklama; Notlar. UTF-8 önerilir.</p>
        </div>
        <div class="form-submit-bar flex flex-wrap items-center gap-3">
            ...
            <a href="/odalar/excel-sablon" class="btn-touch inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <i class="bi bi-download"></i> Örnek şablon indir
            </a>
            <a href="/odalar" class="btn-touch inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-gray-600 dark:text-gray-400 font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">İptal</a>
        </div>
    </form>
</div>

<div class="mt-6 p-4 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700">
    <h3 class="text-sm font-semibold text-gray-800 dark:text-white mb-2">Örnek CSV</h3>
    <pre class="text-xs text-gray-600 dark:text-gray-400 overflow-x-auto p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">Depo Adı;Oda No;Alan (m²);Aylık Fiyat;Durum;Kat;Blok;Koridor;Açıklama;Notlar
KARTAL DEPO;101;25;5000;Boş;;;;;
KARTAL DEPO;102;30;6000;Boş;1;A;;;</pre>
</div>
