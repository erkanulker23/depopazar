...
<div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 max-w-2xl">
    <form method="post" action="/odalar/excel-ice-aktar" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="/odalar/excel-sablon" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <i class="bi bi-download"></i> Örnek şablon indir
            </a>
            <a href="/odalar" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-gray-600 dark:text-gray-400 font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">İptal</a>
        </div>
    </form>
</div>
