<?php
$currentPage = 'depolar';
$pageTitle = 'Depolar Excel İçe Aktar';
ob_start();
?>
<div class="mb-6">
    ...
    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-1">Excel ile Depo İçe Aktar</h1>
    <p class="text-sm text-gray-500 dark:text-gray-400">CSV dosyası yükleyerek toplu depo ekleyebilirsiniz.</p>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 max-w-2xl">
    <form method="post" action="/depolar/excel-ice-aktar" enctype="multipart/form-data" class="space-y-4">
        <div>
            ...
            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Sütunlar: Depo Adı; Adres; İl; İlçe; Kat Sayısı; Açıklama; Aktif (Evet/Hayır); Aylık Baz Ücret. UTF-8 önerilir.</p>
        </div>
        <div class="form-submit-bar flex flex-wrap items-center gap-3">
            ...
            <a href="/depolar/excel-sablon" class="btn-touch inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <i class="bi bi-download"></i> Örnek şablon indir
            </a>
            <a href="/depolar" class="btn-touch inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-gray-600 dark:text-gray-400 font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">İptal</a>
        </div>
    </form>
</div>
...
<div class="mt-6 p-4 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700">
    ...
    <pre class="text-xs text-gray-600 dark:text-gray-400 overflow-x-auto p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">Depo Adı;Adres;İl;İlçe;Kat Sayısı;Açıklama;Aktif;Aylık Baz Ücret
KARTAL DEPO;Örnek Mah. Depo Sok. 1;İstanbul;Kartal;2;;Evet;5000</pre>
</div>
