...
$router->post('/musteriler/guncelle', fn() => (new CustomersController($pdo))->update());
...
$router->post('/musteriler/belge-ekle-parca', fn() => (new CustomersController($pdo))->documentUploadChunk());
...
$router->post('/girisler/sozlesme-pdf-yukle', fn() => (new ContractsController($pdo))->uploadContractPdf());
...
$router->post('/odemeler/{id}/tarih-guncelle', fn(array $p) => (new PaymentsController($pdo))->updatePaidAt($p));
...
$router->get('/yetkiler', fn() => (new PermissionsController($pdo))->index());
$router->post('/yetkiler/guncelle', fn() => (new PermissionsController($pdo))->update());
