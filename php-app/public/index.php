...
require APP_ROOT . '/app/models/CreditCard.php';
require APP_ROOT . '/app/models/ExpenseCategory.php';
require APP_ROOT . '/app/models/Expense.php';
require APP_ROOT . '/app/models/Item.php';
require APP_ROOT . '/app/models/Notification.php';
require APP_ROOT . '/app/models/PushSubscription.php';
require APP_ROOT . '/app/PushService.php';
...
require APP_ROOT . '/app/controllers/ExpensesController.php';
